...
public class MapsActivity extends SupportMapFragment  implements OnMapReadyCallback, LocationListener {
    ...
    private LatLng mDefaultLocation = new LatLng(40.714086, 74.228697);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //this.getActivity().setContentView(R.layout.activity_maps);
    ...
    protected void startLocationUpdates() {
        ...
        mFusedLocationProviderClient.requestLocationUpdates(mLocationRequest, mLocationCallback, null/*Looper.myLooper()*/);
    }
